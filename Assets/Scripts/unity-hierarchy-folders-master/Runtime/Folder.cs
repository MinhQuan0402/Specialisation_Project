...
namespace UnityHierarchyFolders.Runtime
{
    ...
    public class Folder : MonoBehaviour
    {
        ...
        {
            index = -1;
            return obj && folders.TryGetValue(obj.GetEntityId().GetHashCode(), out index);
        }
        ...
        public static bool IsFolder(UnityEngine.Object obj) => folders.ContainsKey(obj.GetEntityId().GetHashCode());
        ...
        private void AddFolderData() => folders[this.gameObject.GetEntityId().GetHashCode()] = this._colorIndex;
        private void RemoveFolderData() => folders.Remove(this.gameObject.GetEntityId().GetHashCode());
